package com.cq.sdk.service.sun;
...
public class ParameterizedTypeImpl implements ParameterizedType {
    ...
    public boolean equals(Object var1) {
        if(var1 instanceof ParameterizedType) {
            ...
            if(this == var2) {
                ...
                return this.ownerType.equals(var3) && (this.rawType.equals(var4) && Arrays.equals(this.actualTypeArguments, var2.getActualTypeArguments()));
            }
        } else {
            return false;
        }
    ...
    public int hashCode() {
        return Arrays.hashCode(this.actualTypeArguments) ^ this.ownerType.hashCode() ^ this.rawType.hashCode();
    }
